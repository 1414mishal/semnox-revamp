      ...
      <div class="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        <div class="grid gap-12 lg:grid-cols-12">
          <div data-reveal class="lg:col-span-5">
            <p class="text-sm text-[#ff6a1a]">Vision</p>
          ...
          <div data-reveal class="lg:col-span-7">
            <div class="rounded-md border border-white/15 bg-[#191a1b] p-8">
              <p class="text-sm text-[#ff6a1a]">Mission</p>
              ...
              <div class="mt-8 grid gap-6 border-t border-white/15 pt-6 sm:grid-cols-3">
                <div><p class="text-3xl font-medium" data-count="2800" data-suffix="+">0</p><p class="mt-1 text-xs text-white/45">Sites live worldwide</p></div>
                <div><p class="text-3xl font-medium" data-count="60" data-suffix="+">0</p><p class="mt-1 text-xs text-white/45">Countries</p></div>
                <div><p class="text-3xl font-medium">24/7</p><p class="mt-1 text-xs text-white/45">Global support, all year</p></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        <div class="grid gap-10 lg:grid-cols-12">
          <div data-reveal class="lg:col-span-4">
            <p class="text-sm text-[#ff6a1a]">Recognition</p>
          ...
          <div class="grid gap-4 sm:grid-cols-2 lg:col-span-8">
            <article data-reveal class="rounded-md border border-[#ff6a1a] bg-[#ff6a1a] p-6 text-black">
            ...
            <article data-reveal class="rounded-md border border-white/15 p-6">
              <i data-lucide="award" class="h-8 w-8 text-[#ff6a1a]"></i>
...
${team.map(m => `          <div data-reveal class="group">
        ...
        <div data-reveal class="mt-14 rounded-md border border-white/15 bg-[#191a1b] p-8 sm:p-10">
          <div class="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p class="text-sm text-[#ff6a1a]">And many more</p>
...
${r.clients.map(c => `          <span data-reveal class="rounded-md border border-white/15 bg-[#191a1b] px-4 py-3 text-sm text-white/75 transition-colors hover:border-[#ff6a1a]/60 hover:text-white">${c}</span>`).join("\n")}
        </div>`).join("\n")}
      </div>
    </section>
...
${partnerGroups.map((g, idx) => `        <div data-reveal class="${idx === 0 ? "" : "mt-16 "}flex items-center gap-4 border-b border-white/15 pb-6">
          <i data-lucide="${g.icon}" class="h-7 w-7 text-[#ff6a1a]"></i>
...
${g.partners.map(p => `          <div data-reveal class="flex items-center justify-between gap-3 rounded-md border border-white/15 bg-[#191a1b] px-5 py-4 text-sm text-white/75 transition-colors hover:border-[#ff6a1a]/60 hover:text-white">
    ...
    <section class="bg-[#e9e7e1] py-20 text-black sm:py-28">
      <div data-reveal class="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
          ...
          <a href="contact-us.html" class="group inline-flex min-h-14 shrink-0 items-center justify-center gap-3 self-start rounded-md bg-black px-7 text-base font-medium text-white transition-colors hover:bg-[#ff6a1a] hover:text-black lg:self-auto">
...
${associations.map(a => `          <article data-reveal class="group rounded-md border border-white/15 bg-[#191a1b] p-6 transition duration-300 hover:-translate-y-1 hover:border-[#ff6a1a]/70">
            <div class="flex items-start justify-between">
              <span class="text-2xl font-medium tracking-tight text-[#ff6a1a]">${a.name}</span>
